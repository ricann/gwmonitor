...
function resoSLPacket(pac_kv, ...)
	...
	local data = string.format("SensorNO=%d;1_voltage-Rtd=%.3f,1_voltage-Flag=N;1_light-Rtd=%.3f,1_light-Flag=N;1_a01001-Rtd=%.3f,1_a01001-Flag=N;1_a01002-Rtd=%.3f,1_a01002-Flag=N",
